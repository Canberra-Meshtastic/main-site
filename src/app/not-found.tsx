...
export default function NotFound() {
  return <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center h-[calc(100vh-65px)] p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
